...
import { Text, Box, Input, useToast, Divider, HStack, Center } from "native-base";
import { StatusBar, TouchableOpacity, KeyboardAvoidingView, Platform } from "react-native";
import Footer from "../../../components/Footer";
import * as S from "./styles";
...
export default function Main({ navigation }) {
  ...
  return (
    <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={{ flex: 1 }}>
      {/* Your original component JSX goes here unchanged */}
